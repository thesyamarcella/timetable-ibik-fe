...
const MasterDataRuanganPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (editMode) {
      try {
        await axios.put(`http://localhost:3000/api/rooms/${formData.id}`, formData);
            ...
            <Col md={6}>
              <Form>
                <Form.Group controlId="searchTerm">
                  <Form.Control type="text" placeholder="Cari Ruangan" onChange={handleSearch} />
                </Form.Group>
              </Form>
            </Col>
...
export default MasterDataRuanganPage;
